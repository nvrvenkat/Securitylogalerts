...
# Delete the specific deployment "my-log-metric-deployment"
gcloud deployment-manager deployments delete my-log-metric-deployment --delete-policy=ABANDON --quiet
